...
import type { beneficiariesType } from './Beneficiaries.types';
                ...
                {beneficiariesData.map((user) => {
                  return (
                    <AccordionItem key={user.id} value={`card-${user.id}`}>
                      ...
                      <AccordionContent className="px-5 py-5 text-sm text-gray-500 space-y-5 border-b">
